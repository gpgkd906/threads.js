...
(function (root, factory) {
    ...
    if (exports.Worker && exports.URL) {
        ...
        let cores = navigator.hardwareConcurrency ? navigator.hardwareConcurrency - 1 : 3;
        useWorker = true;
        exports.Worker.prototype.lockStatus = false;
        exports.Worker.prototype.isLocked = function () { return this.lockStatus; };
        exports.Worker.prototype.lock = function () { this.lockStatus = true; };
        exports.Worker.prototype.unlock = function () { this.lockStatus = false; };
    ...
    exports.Thread = {
        spawn: function(param) {
            ...
            let move = param.move || [];
            if(useWorker) {
                let message_id = messageIdIncrementor++;
